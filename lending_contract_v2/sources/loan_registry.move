module lend_x_change::loan_registry {
    use sui::{
    ...
    use fun lend_x_change::price_feed::get_value_by_usd as PriceInfoObject.get_value_by_usd;
    use fun lend_x_change::price_feed::get_price as PriceInfoObject.get_price;
    ...
    fun finish_liquidate_loan_offer<LendCoinType, CollateralCoinType>(
        loan: &mut Loan<LendCoinType, CollateralCoinType>,
        remaining_fund: Coin<LendCoinType>,
        borrower_fee_percent: u64,
        collateral_swapped_amount: u64,
